...
public class AccountDAO {
    ...
    public boolean createAccount(int customerId, int typeId, BigDecimal initialDeposit) {
        // Generate account number using next available ID
        String accountNumber = generateAccountNumber();

        // Using PreparedStatement here to prevent SQL injection
    ...
    // DO NOT call DatabaseConnection.getInstance() in here
